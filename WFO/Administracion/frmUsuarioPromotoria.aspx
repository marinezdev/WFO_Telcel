<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUsuarioPromotoria.aspx.cs" Inherits="WFO.Administracion.frmUsuarioPromotoria"  MasterPageFile="~/Utilerias/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Agregar Usuario Promotoría</h2>
                ...
                <div class="x_content">
                    ...
                    <table>
                        ...
                        <tr><td>Promotoría:</td><td><asp:DropDownList ID="DDLPromotorias" runat="server" class="form-control"></asp:DropDownList>  </td></tr>
