<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmRolAcceso.aspx.cs" Inherits="WFO.Administracion.frmRolAcceso" MasterPageFile="~/Utilerias/Site.Master"%>
                            ...
                            <td valign="top">
                                ...
                                <fieldset id="fieldset01" runat="server" visible="false">
                                    ...
                                    <table id="TablaAgregarModificar" runat="server" visible="false">
                                        <tr><td align="right">Rol:</td><td><asp:DropDownList ID="ddlRol" runat="server" class="form-control"></asp:DropDownList></td></tr>
                                        <tr><td align="right">Ruta de Acceso:</td><td><asp:TextBox ID="txtRuta" runat="server" class="form-control"></asp:TextBox></td></tr>
                                        <tr><td></td><td></td></tr>
                                        <tr>
