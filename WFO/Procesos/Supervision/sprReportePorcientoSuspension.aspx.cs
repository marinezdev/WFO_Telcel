...
namespace WFO.Procesos.Supervision
{
    public partial class sprReportePorcientoSuspension : Utilerias.Comun
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rps.DatosPorcientoSuspension(ref dvgdPorcientoSuspension,ref dvgdMotivosSuspension,ref dxChtTotales, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
