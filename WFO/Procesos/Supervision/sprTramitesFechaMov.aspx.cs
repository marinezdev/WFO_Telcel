...
{
    public partial class sprTramitesFechaMov : Utilerias.Comun
    {
        ...
        {
            tfm.llenarDatos(ref dvgdEstatusTramite, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
