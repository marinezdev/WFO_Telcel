...
namespace WFO.Procesos.Supervision
{
    public partial class sprReporteEstatusTramite : Utilerias.Comun
    {
        ...
        {
            ret.DatosEstatusTramite(ref dvgdEstatusTramite, ref cmbEstatus, CalDesde.Date.ToString(), CalHasta.Date.ToString(), cmbFlujo.SelectedValue.ToString());
        }
        ...
        protected void listaEstatus_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtET = ret.EstatusTramite();
